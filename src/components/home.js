...
function Home() {
  return (
    <div>
      {/* Hero Section */}
      <section id="aboutUS" classNameName="hero container">
        <div classNameName="hero-blue">
          <div>
            <h1>
            ...
            <div classNameName="call-to-action">
              <a href="#" classNameName="button black">
                Donate Now
              </a>
              <a href="#" classNameName="button white">
                Book Pooja
              </a>
            </div>
          </div>
        </div>
        <div classNameName="hero-yellow">
      ...
      <section classNameName="about">
        ...
        <Link to="/about" classNameName="link">Read More</Link>
      </section>

      {/* Upcoming Events */}
      <section id="events" className="upcoming-events container">
            ...
            <div className="events-grid">
              <div className="event-card">
                <div className="card-content">
                  <h3 className="card-title" title="Akshaya Tritiya Special Pooja">Akshaya Tritiya Special
                    Pooja</h3>
                  <div className="card-text">
                    <p>Date: May 15th, 2024</p>
                    <p>Time: 10:00 AM</p>
                  </div>
                  <a href="/events/akshaya-tritiya" className="card-button">More Details</a>
                </div>
              </div>

              <div className="event-card">
                <div className="card-content">
                  <h3 className="card-title" title="Monthly Sankashti Chaturthi">Monthly Sankashti Chaturthi
                  </h3>
                  <div className="card-text">
                    <p>Date: June 3rd, 2024</p>
                    <p>Time: 6:00 PM</p>
                  </div>
                  <a href="/events/sankashti-chaturthi" className="card-button">More Details</a>
                </div>
              </div>

              <div className="event-card">
                <div className="card-content">
                  <h3 className="card-title" title="Annual Temple Anniversary Celebrations">Annual Temple
                    Anniversary Celebrations</h3>
                  <div className="card-text">
                    <p>Date: July 20th, 2024</p>
                    <p>Time: 9:00 AM</p>
                  </div>
                  <a href="/events/temple-anniversary" className="card-button">More Details</a>
                </div>
              </div>
      ...
      <section id="poojas" className="pooja-services container">
            ...
            <div className="pooja-grid">
                <div className="pooja-card">
                    <div className="card-content">
                        <h3 className="card-title">Ganesh Homa</h3>
                        <p className="card-text">This pooja invokes the blessings of Lord Ganesha to remove obstacles and
                            ensure success in all endeavors.</p>
                        <a href="/poojas/ganesh-homa" className="card-button">Book Now</a>
                    </div>
                </div>

                <div className="pooja-card">
                    <div className="card-content">
                        <h3 className="card-title">Abhisheka</h3>
                        <p className="card-text">Performing abhisheka to Lord Ganesha is considered highly auspicious and
                            brings peace and prosperity to the family.</p>
                        <a href="/poojas/abhisheka" className="card-button">Book Now</a>
                    </div>
                </div>

                <div className="pooja-card">
                    <div className="card-content">
                        <h3 className="card-title">Navagraha Pooja</h3>
                        <p className="card-text">This pooja is performed to appease the nine celestial bodies and receive
                            their blessings for good fortune.</p>
                        <a href="/poojas/navagraha-pooja" className="card-button">Book Now</a>
                    </div>
                </div>

                <div className="pooja-card">
                    <div className="card-content">
                        <h3 className="card-title">Satyanarayana Pooja</h3>
                        <p className="card-text">Offering prayers to Lord Vishnu, this pooja is performed for prosperity,
                            health, and family harmony.</p>
                        <a href="/poojas/satyanarayana-pooja" className="card-button">Book Now</a>
                    </div>
                </div>
            </div>
            <Link to="/poojas" classNameName="btn">View All Poojas</Link>
        </section>

      {/* Donate Section */}

      <section id="donations" className="donations-section container">
            ...
            <div className="donation-options">
                <div className="donation-card">
                    ...
                    <a href="/donate/general" className="btn">Donate Now</a>
                </div>

                <div className="donation-card">
                    <h3>Special Pooja Donation</h3>
                    <p>Support specific rituals like Ganesh Homa, Abhisheka, and others to seek divine blessings.</p>
                    <a href="/donate/pooja" className="btn">Donate Now</a>
                </div>
            </div>

            <div className="cta">
                <p>Want to learn more about how your donations are used? <Link to="/donations" classNameName="btn">Donate Now</Link>.
                </p>
            </div>
      ...
      <section id="gallery" className="bento container">
            <h2>
                Gallery
            </h2>
            ...
            <Link to="/gallery" classNameName="link">View Gallery</Link>
        </section>
    </div>
  );
}
